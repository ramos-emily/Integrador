...
export function ModalEditDel({
  ...
  return (
    ...
    >
      <section className="bg-white rounded-lg !p-6 w-[400px] sm:w-[510px] lg:w-[640px] xl:w-[800px] shadow-lg">
        <h2
          id="modal-edit-title"
        ...
        <form
          ...
          aria-describedby="modal-edit-title"
        >
          ...
          <div className="flex justify-end gap-4 !mt-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-md !p-2"
            >
              Cancelar
            </button>
          </div>
